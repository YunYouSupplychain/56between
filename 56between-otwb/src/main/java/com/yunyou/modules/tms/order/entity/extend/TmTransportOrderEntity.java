...
public class TmTransportOrderEntity extends TmTransportOrderHeader {
    ...
    private String isToDispatch;// 是否待配载
    ...
    private long toDispatchOrderQty = 0L;// 待配载订单数
    ...
    public String getIsToDispatch() {
        return isToDispatch;
    }

    public void setIsToDispatch(String isToDispatch) {
        this.isToDispatch = isToDispatch;
    }

    public long getToDispatchOrderQty() {
        return toDispatchOrderQty;
    }

    public void setToDispatchOrderQty(long toDispatchOrderQty) {
        this.toDispatchOrderQty = toDispatchOrderQty;
    }
}
