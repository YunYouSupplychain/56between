...
<div id="icons">
    ...
    <ul class="the-icons">
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-envelope-o"></i>
            fa-envelope-o
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-search-plus"></i>
            fa-search-plus
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-search-minus"></i>
            fa-search-minus
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-power-off"></i>
            fa-power-off
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-o-down"></i>
            fa-arrow-circle-o-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-o-up"></i>
            fa-arrow-circle-o-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-inbox"></i>
            fa-inbox
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-play-circle-o"></i>
            fa-play-circle-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-right"></i>
            fa-rotate-right
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-headphones"></i>
            fa-headphones
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-volume-off"></i>
            fa-volume-off
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-volume-down"></i>
            fa-volume-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-volume-up"></i>
            fa-volume-up
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-text-height"></i>
            fa-text-height
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-text-width"></i>
            fa-text-width
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-align-left"></i>
            fa-align-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-align-center"></i>
            fa-align-center
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-align-right"></i>
            fa-align-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-align-justify"></i>
            fa-align-justify
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-video-camera"></i>
            fa-video-camera
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-picture-o"></i>
            fa-picture-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pencil"></i>
            fa-pencil
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-map-marker"></i>
            fa-map-marker
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pencil-square-o"></i>
            fa-pencil-square-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-square-o"></i>
            fa-share-square-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square-o"></i>
            fa-check-square-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows"></i>
            fa-arrows
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-step-backward"></i>
            fa-step-backward
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fast-backward"></i>
            fa-fast-backward
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fast-forward"></i>
            fa-fast-forward
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-step-forward"></i>
            fa-step-forward
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eject"></i>
            fa-eject
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-left"></i>
            fa-chevron-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-right"></i>
            fa-chevron-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-plus-circle"></i>
            fa-plus-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-minus-circle"></i>
            fa-minus-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-times-circle"></i>
            fa-times-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-circle"></i>
            fa-check-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-question-circle"></i>
            fa-question-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-info-circle"></i>
            fa-info-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-crosshairs"></i>
            fa-crosshairs
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-times-circle-o"></i>
            fa-times-circle-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-circle-o"></i>
            fa-check-circle-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ban"></i>
            fa-ban
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-left"></i>
            fa-arrow-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-right"></i>
            fa-arrow-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-up"></i>
            fa-arrow-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-down"></i>
            fa-arrow-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-forward"></i>
            fa-mail-forward
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-exclamation-circle"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eye-slash"></i>
            fa-eye-slash
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-warning"></i>
            fa-warning
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-exclamation-triangle"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-up"></i>
            fa-chevron-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-down"></i>
            fa-chevron-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-retweet"></i>
            fa-retweet
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shopping-cart"></i>
            fa-shopping-cart
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-folder"></i>
            fa-folder
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-folder-open"></i>
            fa-folder-open
        </li>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart-o"></i>
            fa-bar-chart-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-twitter-square"></i>
            fa-twitter-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-facebook-square"></i>
            fa-facebook-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-camera-retro"></i>
            fa-camera-retro
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-thumbs-o-up"></i>
            fa-thumbs-o-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-thumbs-o-down"></i>
            fa-thumbs-o-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half"></i>
            fa-star-half
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-linkedin-square"></i>
            fa-linkedin-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-thumb-tack"></i>
            fa-thumb-tack
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-external-link"></i>
            fa-external-link
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-github-square"></i>
            fa-github-square
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bookmark-o"></i>
            fa-bookmark-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-phone-square"></i>
            fa-phone-square
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-credit-card"></i>
            fa-credit-card
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-certificate"></i>
            fa-certificate
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-o-right"></i>
            fa-hand-o-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-o-left"></i>
            fa-hand-o-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-o-up"></i>
            fa-hand-o-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-o-down"></i>
            fa-hand-o-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-left"></i>
            fa-arrow-circle-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-right"></i>
            fa-arrow-circle-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-up"></i>
            fa-arrow-circle-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-down"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows-alt"></i>
            fa-arrows-alt
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paperclip"></i>
            fa-paperclip
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-strikethrough"></i>
            fa-strikethrough
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-underline"></i>
            fa-underline
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pinterest"></i>
            fa-pinterest
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pinterest-square"></i>
            fa-pinterest-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-google-plus-square"></i>
            fa-google-plus-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-google-plus"></i>
            fa-google-plus
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-money"></i>
            fa-money
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-down"></i>
            fa-caret-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-up"></i>
            fa-caret-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-left"></i>
            fa-caret-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-right"></i>
            fa-caret-right
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-down"></i>
            fa-sort-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-desc"></i>
            fa-sort-desc
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-left"></i>
            fa-rotate-left
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dashboard"></i>
            fa-dashboard
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-tachometer"></i>
            fa-tachometer
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-comment-o"></i>
            fa-comment-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-comments-o"></i>
            fa-comments-o
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-clipboard"></i>
            fa-clipboard
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-lightbulb-o"></i>
            fa-lightbulb-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-exchange"></i>
            fa-exchange
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cloud-download"></i>
            fa-cloud-download
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cloud-upload"></i>
            fa-cloud-upload
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-user-md"></i>
            fa-user-md
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stethoscope"></i>
            fa-stethoscope
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-text-o"></i>
            fa-file-text-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-building-o"></i>
            fa-building-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hospital-o"></i>
            fa-hospital-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ambulance"></i>
            fa-ambulance
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-medkit"></i>
            fa-medkit
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fighter-jet"></i>
            fa-fighter-jet
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-plus-square"></i>
            fa-plus-square
        </li>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-double-right"></i>
            fa-angle-double-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-double-up"></i>
            fa-angle-double-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-double-down"></i>
            fa-angle-double-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-left"></i>
            fa-angle-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-right"></i>
            fa-angle-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-up"></i>
            fa-angle-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angle-down"></i>
            fa-angle-down
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mobile-phone"></i>
            fa-mobile-phone
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-quote-left"></i>
            fa-quote-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-quote-right"></i>
            fa-quote-right
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply"></i>
            fa-mail-reply
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reply"></i>
            fa-reply
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-github-alt"></i>
            fa-github-alt
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-folder-o"></i>
            fa-folder-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-folder-open-o"></i>
            fa-folder-open-o
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-keyboard-o"></i>
            fa-keyboard-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-flag-o"></i>
            fa-flag-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-flag-checkered"></i>
            fa-flag-checkered
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply-all"></i>
            fa-mail-reply-all
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reply-all"></i>
            fa-reply-all
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-empty"></i>
            fa-star-half-empty
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-full"></i>
            fa-star-half-full
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-o"></i>
            fa-star-half-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-location-arrow"></i>
            fa-location-arrow
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-crop"></i>
            fa-crop
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-code-fork"></i>
            fa-code-fork
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unlink"></i>
            fa-unlink
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chain-broei"></i>
            fa-chain-broei
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-exclamation"></i>
            fa-exclamation
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-superscript"></i>
            fa-superscript
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-subscript"></i>
            fa-subscript
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eraser"></i>
            fa-eraser
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-puzzle-piece"></i>
            fa-puzzle-piece
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-microphone"></i>
            fa-microphone
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-microphone-slash"></i>
            fa-microphone-slash
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shield"></i>
            fa-shield
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-calendar-o"></i>
            fa-calendar-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fire-extinguisher"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-circle-left"></i>
            fa-chevron-circle-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-circle-right"></i>
            fa-chevron-circle-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-circle-up"></i>
            fa-chevron-circle-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chevron-circle-down"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unlock-alt"></i>
            fa-unlock-alt
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bullseye"></i>
            fa-bullseye
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ellipsis-h"></i>
            fa-ellipsis-h
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ellipsis-v"></i>
            fa-ellipsis-v
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rss-square"></i>
            fa-rss-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-play-circle"></i>
            fa-play-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ticket"></i>
            fa-ticket
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-minus-square"></i>
            fa-minus-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-minus-square-o"></i>
            fa-minus-square-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-level-up"></i>
            fa-level-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-level-down"></i>
            fa-level-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i>
            fa-check-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pencil-square"></i>
            fa-pencil-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-external-link-square"></i>
            fa-external-link-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-square"></i>
            fa-share-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-compass"></i>
            fa-compass
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-down"></i>
            fa-toggle-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-square-o-down"></i>
            fa-caret-square-o-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-up"></i>
            fa-toggle-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-square-o-up"></i>
            fa-caret-square-o-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-right"></i>
            fa-toggle-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-square-o-right"></i>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-text"></i>
            fa-file-text
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-alpha-asc"></i>
            fa-sort-alpha-asc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-alpha-desc"></i>
            fa-sort-alpha-desc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-amount-asc"></i>
            fa-sort-amount-asc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-amount-desc"></i>
            fa-sort-amount-desc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-numeric-asc"></i>
            fa-sort-numeric-asc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-numeric-desc"></i>
            fa-sort-numeric-desc
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-thumbs-up"></i>
            fa-thumbs-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-thumbs-down"></i>
            fa-thumbs-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-youtube-square"></i>
            fa-youtube-square
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-xing-square"></i>
            fa-xing-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-youtube-play"></i>
            fa-youtube-play
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dropbox"></i>
            fa-dropbox
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stack-overflow"></i>
            fa-stack-overflow
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-instagram"></i>
            fa-instagram
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bitbucket"></i>
            fa-bitbucket
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bitbucket-square"></i>
            fa-bitbucket-square
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-long-arrow-down"></i>
            fa-long-arrow-down
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-long-arrow-up"></i>
            fa-long-arrow-up
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-long-arrow-left"></i>
            fa-long-arrow-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-long-arrow-right"></i>
            fa-long-arrow-right
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-foursquare"></i>
            fa-foursquare
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pagelines"></i>
            fa-pagelines
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stack-exchange"></i>
            fa-stack-exchange
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-o-right"></i>
            fa-arrow-circle-o-right
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrow-circle-o-left"></i>
            fa-arrow-circle-o-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-left"></i>
            fa-toggle-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-caret-square-o-left"></i>
            fa-caret-square-o-left
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dot-circle-o"></i>
            fa-dot-circle-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wheelchair"></i>
            fa-wheelchair
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-vimeo-square"></i>
            fa-vimeo-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-turkish-lira"></i>
            fa-turkish-lira
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-try"></i>
            fa-try
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-plus-square-o"></i>
            fa-plus-square-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-space-shuttle"></i>
            fa-space-shuttle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-slack"></i>
            fa-slack
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-envelope-square"></i>
            fa-envelope-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wordpress"></i>
            fa-wordpress
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-openid"></i>
            fa-openid
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-institution"></i>
            fa-institution
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bank"></i>
            fa-bank
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-university"></i>
            fa-university
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mortar-board"></i>
            fa-mortar-board
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-graduation-cap"></i>
            fa-graduation-cap
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reddit-square"></i>
            fa-reddit-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stumbleupon-circle"></i>
            fa-stumbleupon-circle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stumbleupon"></i>
            fa-stumbleupon
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-delicious"></i>
            fa-delicious
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-digg"></i>
            fa-digg
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pied-piper-square"></i>
            fa-pied-piper-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pied-piper"></i>
            fa-pied-piper
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pied-piper-alt"></i>
            fa-pied-piper-alt
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-behance-square"></i>
            fa-behance-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-steam"></i>
            fa-steam
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-steam-square"></i>
            fa-steam-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-recycle"></i>
            fa-recycle
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-automobile"></i>
            fa-automobile
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-deviantart"></i>
            fa-deviantart
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-soundcloud"></i>
            fa-soundcloud
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-database"></i>
            fa-database
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-pdf-o"></i>
            fa-file-pdf-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-word-o"></i>
            fa-file-word-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-excel-o"></i>
            fa-file-excel-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-powerpoint-o"></i>
            fa-file-powerpoint-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-photo-o"></i>
            fa-file-photo-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-picture-o"></i>
            fa-file-picture-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-image-o"></i>
            fa-file-image-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-zip-o"></i>
            fa-file-zip-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-archive-o"></i>
            fa-file-archive-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-sound-o"></i>
            fa-file-sound-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-audio-o"></i>
            fa-file-audio-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-movie-o"></i>
            fa-file-movie-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-video-o"></i>
            fa-file-video-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-code-o"></i>
            fa-file-code-o
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-bouy"></i>
            fa-life-bouy
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-saver"></i>
            fa-life-saver
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-support"></i>
            fa-support
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-ring"></i>
            fa-life-ring
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-o-notch"></i>
            fa-circle-o-notch
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-git-square"></i>
            fa-git-square
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-git"></i>
            fa-git
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hacker-news"></i>
            fa-hacker-news
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-tencent-weibo"></i>
            fa-tencent-weibo
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paper-plane"></i>
            fa-paper-plane
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send-o"></i>
            fa-send-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paper-plane-o"></i>
            fa-paper-plane-o
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-history"></i>
            fa-history
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-thin"></i>
            fa-circle-thin
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-header"></i>
            fa-header
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paragraph"></i>
            fa-paragraph
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sliders"></i>
            fa-sliders
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-alt"></i>
            fa-share-alt
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-alt-square"></i>
            fa-share-alt-square
        </li>
