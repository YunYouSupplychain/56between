...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            '<div class="bootstrap-table" id="bootstrap-table-id">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if(this.options.message){//add by zqs 用于添加列表汇总标识
                html.push('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
                html.push('<span class="pagination-info">');
                html.push('<b>');
                html.push(this.options.message);
                html.push('</b>');
                html.push('</span>');
            }
    ...
    BootstrapTable.prototype.getIndexByField = function (obj) {
        if (!obj.hasOwnProperty('field') || !obj.hasOwnProperty('values')) {
            return;
        }
    ...
    var allowedMethods = [
        'getOptions',
        'getSelections', 'getAllSelections', 'getData', 'getIndexByField',
