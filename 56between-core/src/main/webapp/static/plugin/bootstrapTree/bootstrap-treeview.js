...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype.css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:10px;margin-right:10px}.treeview span.icon{width:10px;margin-right:3px;margin-left:0px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
